...
describe("annotator 테스트 시작", () => {
  ...
  describe("reducer", () => {
    ...
    it("createLabels가 제대로 수행되어야 한다.", () => {
      ...
      const labelBody = document.createElementNS(svgNS, "rect");
      ...
      const _data = { x: 10, y: 20, w: 100, h: 50, deg: 0 };
    ...
    it("updateImgLabels가 제대로 수행되어야 한다.", () => {
      ...
      const _data = { x: 30, y: 30, w: 150, h: 150, deg: 0 };
